...
const API_LABELS = ["Request", "Response"] // for displaying which api input textarea and source of truth to show
...
function JsonInput() {
	...
	async function handleAnalyze() {
		// reset previous error (when user re-analyzes due to an error on their previous input):
